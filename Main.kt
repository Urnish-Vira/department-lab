...
fun main () {
    ...
    var Mila =  Designer("Mila","Yovovich",1500.00, 2, 0.6);
    var Katia =  Designer("Katia","Petrova",1500.00, 1, 0.7);
    var Danya =  Designer("Danya","Molchanov",1500.00, 4, 0.8);
    var Daria =  Designer("Daria","Kovalenko",1500.00, 6, 0.9);

    var Borys =  Manager("Borys","Nachalnik",4000.00, 6);
    var Platon =  Manager("Platon","Nachalnik",5000.00, 4);
